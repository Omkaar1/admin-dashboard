...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Log only when submitting
    console.log('Name at submit:', name); // Logs only when the user submits the form
    ...
    try {
      const response = await axios.post(
        'http://localhost:5173/auth/signupPage',
        {
          name,
          email,
          password,
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                ...
                <div className="flex">
                  {/* <img className="dark:hidden border" src={Logo} alt="Logo" /> */}
